...
With GRID
     ...
     .Col = 4: .ColWidth(4) = 1500: .Text = "Merk/Model": .CellAlignment = 4
     .Col = 5: .ColWidth(5) = 1500: .Text = "No. Seri Pabrik": .CellAlignment = 4
     .Col = 6: .ColWidth(6) = 1500: .Text = "Ukuran": .CellAlignment = 4
     .Col = 7: .ColWidth(7) = 1000: .Text = "Bahan": .CellAlignment = 4
     .Col = 8: .ColWidth(8) = 3000: .Text = "Tahun": .CellAlignment = 4
     .Col = 9: .ColWidth(9) = 1000: .Text = "Jumlah Brg": .CellAlignment = 4
     .Col = 10: .ColWidth(10) = 1000: .Text = "Harga Perolehan": .CellAlignment = 4
     .Col = 11: .ColWidth(11) = 1000: .Text = "Nilai Pasar": .CellAlignment = 4
     .Col = 12: .ColWidth(12) = 1000: .Text = "Kondisi": .CellAlignment = 4
     .Col = 13: .ColWidth(13) = 1000: .Text = "Ket. Mutasi": .CellAlignment = 4
End With
End Sub

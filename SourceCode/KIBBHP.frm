...
Begin VB.Form KIBBHP 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Daftar Barang Pakai Habis"
   ClientHeight    =   6525
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   11265
...
With GRID
     ...
     .Col = 3: .ColWidth(3) = 1000: .Text = "Harga Sat": .CellAlignment = 4
     .Col = 4: .ColWidth(4) = 1500: .Text = "Jumlah Masuk": .CellAlignment = 4
     .Col = 5: .ColWidth(5) = 1500: .Text = "Jumlah Keluar": .CellAlignment = 4
     .Col = 6: .ColWidth(6) = 1500: .Text = "Jumlah Kini": .CellAlignment = 4
     .Col = 7: .ColWidth(7) = 1500: .Text = "Total Harga": .CellAlignment = 4
     .Col = 8: .ColWidth(8) = 1000: .Text = "Ruang": .CellAlignment = 4
     .Col = 9: .ColWidth(9) = 1000: .Text = "Tanggal Bgn": .CellAlignment = 4
     .Col = 10: .ColWidth(10) = 3000: .Text = "Keterangan": .CellAlignment = 4
End With
End Sub

...
Begin VB.Form KELOMPOK 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "TABEL KELOMPOK BARANG KIR"
   ClientHeight    =   6840
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9705
...
SCari = "Delete from KELOMPOKBRG where BIDANG = '" + Trim(Text1) + "' and URAIAN = '" + Trim(GRIDKLIK2) + "' "
...
With GRID
     .Cols = 2
     .Row = 0
     .Col = 0: .ColWidth(0) = 1350: .Text = "Bidang": .CellAlignment = 4
     .Col = 1: .ColWidth(1) = 3500: .Text = "Uraian": .CellAlignment = 4
End With
End Sub
    ...
    End If
        With GRID
            If BB = 0 Then
                .Rows = Brs + 1
                .Row = Brs
                .Col = 0: .Text = RCari("BIDANG"): .CellBackColor = &HFFFFC0: .CellAlignment = 4
                .Col = 1: .Text = RCari("URAIAN"): .CellBackColor = &HFFFFC0
            ElseIf BB = 1 Then
                .Rows = Brs + 1
                .Row = Brs
                .Col = 0: .Text = RCari("BIDANG"): .CellAlignment = 4
                .Col = 1: .Text = RCari("URAIAN")
            End If
        End With
            RCari.MoveNext
            Brs = Brs + 1
